...
.sub-out td{padding:7px 12px;border-bottom:1px solid rgb(239,231,216)}
.sub-out td:first-child{color:rgb(95,107,122);font-weight:600}
.sub-out td:last-child{font-family:monospace;font-weight:700;text-align:right;color:rgb(30,36,48)}
...
.bn{color:rgb(37,73,184);font-weight:700}.bh{color:rgb(198,122,0);font-weight:700}
.sub-err{color:rgb(204,59,42);text-align:center;font-weight:700}
</style></head>
